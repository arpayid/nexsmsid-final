      ...
      <header className="sticky top-0 z-40 border-b border-border bg-card/95 backdrop-blur">
        <div className="mx-auto flex max-w-7xl items-center justify-between gap-4 px-4 py-3 sm:px-6 lg:px-8">
          <Link className="flex min-w-0 items-center gap-3" href="/">
            {profile?.logoUrl ? (
              <img alt="" className="h-10 w-10 rounded-lg object-cover" data-school-logo src={profile.logoUrl} />
            ) : (
            ...
            <span className="min-w-0">
              ...
              <span className="block truncate text-xs text-muted-foreground">Website Resmi Sekolah</span>
            </span>
          </Link>
      ...
      <footer className="border-t border-border bg-card">
        <div className="mx-auto grid max-w-7xl gap-8 px-4 py-10 sm:px-6 lg:grid-cols-[1.2fr_0.8fr] lg:px-8">
          ...
          <div className="space-y-2 text-sm">
            ...
            <Link className="block text-muted-foreground hover:text-primary" href="/ppdb">
              PPDB Online
            </Link>
            <Link className="block text-muted-foreground hover:text-primary" href="/announcements">
              Pengumuman
            </Link>
            <Link className="block text-muted-foreground hover:text-primary" href="/jobs">
              Lowongan Kerja
            </Link>
            <Link className="block text-muted-foreground hover:text-primary" href="/login">
              Login Staf / Siswa
            </Link>
            <p className="pt-4 text-xs text-muted-foreground">Didukung oleh NexSMSID</p>
          </div>
        </div>
      </footer>
    </div>
