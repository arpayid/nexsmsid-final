...
import { BarChart3, Download, FileText, Loader2, Filter, CheckCircle2, Clock } from "lucide-react";

import { Button, ErrorState, Input, PageHeader, SectionCard, StatCard, Badge } from "@nexsmsid/ui";
...
export default function AdminReportsPage() {
  ...
  return (
    <div className="space-y-8 pb-20">
      ...
      {error ? <ErrorState message={error} onRetry={() => void refetch()} title="Gagal memproses laporan" /> : null}

      {loading ? (
        <SectionCard title="Memuat Report Center">
        ...
        <>
          ...
          <div className="grid gap-8 lg:grid-cols-3">
            <div className="lg:col-span-2 space-y-6">
              <SectionCard title="Pilih Laporan">
            ...
            <div className="space-y-6">
              {selectedReport ? (
                <SectionCard className="border-primary/20 bg-primary/5" title="Filter Laporan">
              ...
              <SectionCard contentClassName="p-0 pt-0" title="Recent Jobs">
