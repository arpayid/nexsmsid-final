...
export default function StudentDisciplinePage() {
  ...
  const loadSummary = useCallback(() => api.getStudentPortalDiscipline(), [api]);
  const { data: summary, error, loading } = useApiQuery<StudentDisciplinePortalSummary>(loadSummary, [api]);
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        breadcrumb={["Portal Siswa", "Kedisiplinan"]}
        description="Ringkasan poin pelanggaran confirmed dan prestasi Anda."
